...
class Barriers {
  ...
  private static void StoreCountHelper(Assembler asm, BaselineCompilerImpl compiler, NormalMethod counter) {
  ...
  static void compileArrayStoreCount(Assembler asm, BaselineCompilerImpl compiler) {
    StoreCountHelper(asm, compiler, Entrypoints.ArrayWriteCountMethod);
  }

  static void compileFieldStoreCount(Assembler asm, BaselineCompilerImpl compiler) {
    StoreCountHelper(asm, compiler, Entrypoints.FieldWriteCountMethod);
  }
  /**
